...
| C2 | Fusión de modales "Editar Estudiante" + "Ficha Familiar" — frontend: modal único `modal-xl`, botón "Guardar" único, foto arriba, ficha debajo, botón PDF trasladado al final del modal | ⬜ |
| D | Configuración institucional en `08_admin` — número de matrícula inicial, Director, Secretario | ⬜ |
| E | Columnas nuevas en `matriculas` — folio, fecha, observaciones, número | ⬜ |
| F | Exportación PDF Hoja de Matrícula, formato AC-FO-09 | ⬜ |
