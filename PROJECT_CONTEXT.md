...
> Versión: 127 — Candado en Eliminar de actividades N3 filtrado por roster vigente (commit `8613a13`) — `listar_actividades_n3`/`eliminar_actividad_n3` cuentan solo notas de estudiantes que siguen en el grupo módulo; color del encabezado N3 pasa a azul marino oscuro compatible con `table-dark` (commit `d7cf505`).
