...
<head>
    ...
    <title>Actualización de Datos — EMDB Académica</title>
...
<nav class="navbar navbar-dark bg-dark px-3">
    <span class="navbar-brand fw-bold">Escuela de Mecánica Dental Bolaños — Actualización de Datos</span>
</nav>
...
<div class="container mt-4 mb-5">
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            ...
            <div id="bloque_cargando" class="text-center text-muted py-5">
                Cargando...
            </div>

            <div id="bloque_error" class="d-none">
                <div class="alert alert-warning">
                    <h5 class="alert-heading" id="txt_error_titulo">Link no disponible</h5>
                    <p class="mb-0" id="txt_error_mensaje"></p>
                </div>
            </div>

            <div id="form_actualizacion" class="d-none">
                <div class="mb-4">
                    <h4 class="mb-2">ACTUALIZACIÓN DE DATOS</h4>
                    <div class="alert alert-info mb-0">
                        Revisa y corrige tus datos personales y los de tu núcleo
                        familiar. Todos los campos marcados son obligatorios; si
                        tu padre, tu madre o tu acudiente no aplican, desmarca la
                        casilla correspondiente y esos campos se ocultarán
                        automáticamente. <strong>Ten cuidado: si cierras o
                        recargas esta página sin enviar el formulario, los
                        cambios ingresados se perderán.</strong> Estos cambios no
                        se aplican de inmediato — el coordinador los revisará
                        antes de confirmarlos.
                    </div>
                </div>

                <div class="alert alert-secondary">
                    Estás actualizando los datos de:
                    <strong id="txt_encabezado_nombre"></strong>,
                    documento <strong id="txt_encabezado_documento"></strong>
                </div>

                <input type="hidden" id="npt_token" value="">

                <h6 class="seccion-titulo">1. Datos del Estudiante</h6>
                <div class="row">
                    <div class="col-md-2 mb-3">
                        <label class="form-label">Tipo de documento</label>
                        <p class="form-control-plaintext fw-bold" id="txt_estu_tipodoc"></p>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Número de documento</label>
                        <p class="form-control-plaintext fw-bold" id="txt_estu_numerodoc"></p>
                    </div>
                ...
                <button type="button" class="btn btn-primary" id="btn_guardar_actualizacion">Guardar actualización</button>
            </div>

            <div id="bloque_confirmacion" class="d-none">
                <div class="alert alert-success">
                    <h5 class="alert-heading">¡Datos enviados!</h5>
                    <p class="mb-0">Tus datos fueron enviados. El coordinador los
                        revisará antes de aplicarlos.</p>
                </div>
            </div>
...
<script src="actualizar_ctrl.js"></script>
</body>
</html>
