...
> **Formulario público de inscripción:** Fases 0-3 de 5 completas (reCAPTCHA, Ficha Familiar interna, migración `estu_origen`, formulario público en dos pasos). Fase 4 (mostrar origen en listado de Aspirantes) y Fase 5 (documentación final) pendientes.
